"""
here we compute the overlap of stem final consonants across predictions set and train set for wrong predictions of L-shaped verbs.
"""
...
if __name__ == "__main__":
    for model in all_models:
        ...
        for pred_triple, pred, test, shape in zip(
            pred_triples, predictions, true_tests, shapes
        ):
            if shape == "L":
                if pred != test:
