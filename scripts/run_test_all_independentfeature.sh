...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-${BASE_DIR}/example/transformer/checkpoints/transformer/independent_feature_transformer}"
...
OUTPUT_DIR="${OUTPUT_DIR:-predictions_nevins/independentfeature}"

# Common args
COMMON_ARGS="--eval_test --arch independentfeature --dataset taginbrackets --bs 16 --decode beam --decode_beam_size 5"
